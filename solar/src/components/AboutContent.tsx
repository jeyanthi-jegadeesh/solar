...
const About = () => (
  <Box bgGradient='linear(to-t, blue.700, black)' opacity={0.9} w='100%' color='white' padding="6" maxW="3xl" margin="auto">
    ...
    <Box display="flex" justifyContent="flex-end">
        <Link as={NextLink} href='/explore' fontSize='lg'  fontWeight='bold' color='white'>
            EXPLORE
        </Link>
    </Box>
  </Box>
